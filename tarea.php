<?php 
    ...
    function loadTarea($conexion) { 
        if(isset($_POST['materia']) != TRUE)
        {
            ...
            $sql = "SELECT id_tarea, id_materia, nombre_tarea, DATE_FORMAT(fecha_inicio, '%d-%m-%Y') AS fecha_inicio, hora_inicio, prioridad, observacion, completada FROM tarea
            WHERE id_semestre = '$id_sem' AND id_compartir = 0
        ...
        else if($_POST['materia'] >= 19) //Por materias creadas
        {
            ...
            $sql = "SELECT id_tarea, id_materia, nombre_tarea, DATE_FORMAT(fecha_inicio, '%d-%m-%Y') AS fecha_inicio, hora_inicio, prioridad, observacion, completada FROM tarea
            WHERE id_materia = '$idMateria' AND id_compartir = 0
            ORDER BY fecha_inicio DESC, hora_inicio DESC;";
        ...
        {
            $sql = "SELECT id_tarea, id_materia, nombre_tarea, DATE_FORMAT(fecha_inicio, '%d-%m-%Y') AS fecha_inicio, hora_inicio, prioridad, observacion, completada FROM tarea
            WHERE completada = 1 AND id_compartir = 0
            ORDER BY fecha_inicio DESC, hora_inicio DESC;";
        ...
        {
            $sql = "SELECT id_tarea, id_materia, nombre_tarea, DATE_FORMAT(fecha_inicio, '%d-%m-%Y') AS fecha_inicio, hora_inicio, prioridad, observacion, completada FROM tarea
            WHERE completada = 0 AND id_compartir = 0
            ORDER BY fecha_inicio DESC, hora_inicio DESC;";
